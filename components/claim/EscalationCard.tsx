      ...
      <div className="px-6 py-6">
        ...
        <div className="mt-6">
          {!raised ? (
            ...
            <div className="anim-rise rounded-panel border border-white/10 bg-white/[0.05] p-5">
              ...
              <p className="pretty mt-3 rounded-tile bg-white/[0.05] px-3.5 py-2.5 text-[12px] leading-relaxed text-white/45">
                Nothing was submitted anywhere. This prototype has no connection
                to EPFiGMS or any government system. To file a real grievance,
                use the official EPFiGMS portal.
              </p>
              <button
